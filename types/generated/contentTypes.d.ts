...
export interface ApiLawCateLawCate extends Schema.CollectionType {
  collectionName: 'law_cates';
  info: {
...
export interface ApiLawPostLawPost extends Schema.CollectionType {
  collectionName: 'law_posts';
  info: {
    singularName: 'law-post';
    pluralName: 'law-posts';
    displayName: 'Law post';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    link_download_origin: Attribute.String;
    law_cate: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::law-cate.law-cate': ApiLawCateLawCate;
      'api::law-post.law-post': ApiLawPostLawPost;
    }
  }
}
